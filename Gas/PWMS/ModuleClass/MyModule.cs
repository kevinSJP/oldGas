...
namespace PWMS.ModuleClass
{
    class MyModule
    {
        ...
        public void Show_Form(string FrmName, int n)
        {
            ...
            if (n == 1)
            {
                if (FrmName == "烧结")  //判断要打开的窗体
                {
                    PerForm.F_GasView FrmWordPad = new PWMS.PerForm.F_GasView();
                    FrmWordPad.Text = "烧结";
                    flag = 1;
                    FrmWordPad.ShowDialog();
                    FrmWordPad.Dispose();
                }
                if (FrmName == "焦炉")  //判断要打开的窗体
                {
                    PerForm.F_GasView FrmWordPad = new PWMS.PerForm.F_GasView();
                    FrmWordPad.Text = "焦炉";
                    flag = 2;
                ...
                if (FrmName == "高炉")  //判断要打开的窗体
                {
                    PerForm.F_GasView FrmWordPad = new PWMS.PerForm.F_GasView();
                    FrmWordPad.Text = "高炉";
                    flag = 3;
                    FrmWordPad.ShowDialog();
                    //FrmWordPad.ActiveControl
                    FrmWordPad.Dispose();

                }
                if (FrmName == "转炉")  //判断要打开的窗体
                {
                    PerForm.F_GasView FrmWordPad = new PWMS.PerForm.F_GasView();
                    FrmWordPad.Text = "转炉";
                    flag = 4;
                ...
                if (FrmName == "高炉煤气")  //判断当前要打开的窗体
                {
                    PerForm.F_GasPre FrmManFile = new PWMS.PerForm.F_GasPre();
                    FrmManFile.Text = "高炉煤气";   //设置窗体名称
                    //FrmManFile.Column1.HeaderText = "时间点";
                    //FrmManFile.Column2.HeaderText = "煤气预测值";
                    //FrmManFile.Column3.HeaderText = "煤气实际量";
                    //FrmManFile.Column4.HeaderText = "铁矿石消耗量";
                    //FrmManFile.Column5.HeaderText = "鼓风量";
                    //FrmManFile.Column6.HeaderText = "鼓风温度";
                    //FrmManFile.Column7.HeaderText = "含氧量";
                    //FrmManFile.Column8.HeaderText = "炉顶压力";
                    FrmManFile.ShowDialog();    //显示窗体
                    FrmManFile.Dispose();
                }
                if (FrmName == "焦炉煤气")  //判断当前要打开的窗体
                {
                    PerForm.F_GasPre FrmManFile = new PWMS.PerForm.F_GasPre();
                    //FrmManFile.Text = "焦炉煤气";   //设置窗体名称
                    //FrmManFile.Column1.HeaderText = "煤气发生量";
                    //FrmManFile.Column2.HeaderText = "焦炭量";
                    //FrmManFile.Column3.HeaderText = "炼焦温度";
                    //FrmManFile.Column4.HeaderText = "炉内压力";
                    //FrmManFile.Column5.Visible = false;
                    //FrmManFile.Column6.Visible = false;
                    FrmManFile.ShowDialog();    //显示窗体
                    FrmManFile.Dispose();
                }
                if (FrmName == "转炉煤气")  //判断当前要打开的窗体
                {
                    PerForm.F_GasPre FrmManFile = new PWMS.PerForm.F_GasPre();
                    FrmManFile.Text = "转炉煤气";   //设置窗体名称
                    //FrmManFile.Column1.HeaderText = "煤气发生量";
                    //FrmManFile.Column2.HeaderText = "铁水量";
                    //FrmManFile.Column3.HeaderText = "铁水温度";
                    //FrmManFile.Column4.HeaderText = "耗氧量";
                    //FrmManFile.Column5.HeaderText = "工作压力";
                    //FrmManFile.Column6.Visible = false;
                    FrmManFile.ShowDialog();    //显示窗体
                    FrmManFile.Dispose();
                }
                if (FrmName == "热风炉煤气")  //判断当前要打开的窗体
                {
                    PerForm.F_GasPre FrmManFile = new PWMS.PerForm.F_GasPre();
                    FrmManFile.Text = "热风炉煤气";   //设置窗体名称
                    //FrmManFile.Column1.HeaderText = "煤气消耗量";
                    //FrmManFile.Column2.HeaderText = "鼓风量";
                    //FrmManFile.Column3.HeaderText = "空气流量";
                    //FrmManFile.Column4.HeaderText = "耗氧量";
                    //FrmManFile.Column5.HeaderText = "炉内压力";
                    //FrmManFile.Column6.Visible = false;
                    FrmManFile.ShowDialog();    //显示窗体
                    FrmManFile.Dispose();
                }
        ...
        public void ADD_Pope(string ID,int n)
        {
            ...
            {
                DataClass.MyMeans.getsqlcom("insert into tb_UserPope (ID,PopeName,Pope) values('" + ID + "','" + Convert.ToString(DSet.Tables[0].Rows[i][0]) + "'," + n + ")");
            }
        }
        #endregion
                ...
                if (C.GetType().Name == "CheckBox")
                {
                    ...
                    if (sID.IndexOf(TName) > -1)
                    {
                        if (((CheckBox)C).Checked == true)
                        {
                            ...
                            {
                                DataClass.MyMeans.getsqlcom("update " + TableName + " set Fate=0,Unlock=0 where ID>0");
                            }
                            else
                            {
                                DataClass.MyMeans.getsqlcom("Delete " + TableName);
                                if (Astr[1].ToUpper() == ("Login").ToUpper())
                                {
                                    DataClass.MyMeans.getsqlcom("insert into " + TableName + " (ID,Name,Pass) values('0001','TSoft','111')");
                                    ADD_Pope("0001", 1);
                                }
                            }
                        }
        ...
        public void Amend_Pope(Control.ControlCollection GBox, string TID)
        {
            ...
            foreach (Control C in GBox)
            {
                if (C.GetType().Name == "CheckBox")
                {
                    ...
                    DataClass.MyMeans.getsqlcom("update tb_UserPope set Pope=" + tt + " where (ID='" + TID + "') and (PopeName='" + Astr[1].Trim() + "')");
                }
            }
